                ...
                Admob.getInstance().showInterAds(VideoPlayerActivity.this, Constant.interBackVideo, new InterCallback() {
                    ...
                    public void onAdClosedByUser() {
                        ...
                        if (!SharePreferenceUtils.isOrganic(getApplicationContext())) {
                            Intent intent = new Intent(VideoPlayerActivity.this, ActivityLoadNativeFull.class);
                            intent.putExtra(ActivityLoadNativeFull.EXTRA_NATIVE_AD_ID, getString(R.string.native_full_back_video));
                            startActivity(intent);
                        }
